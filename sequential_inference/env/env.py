...
from sequential_inference.env.wrappers import (
    BraxWrapper,
    MetaworldWrapper,
    PyTorchWrapper,
)
...
def setup_brax_env(env_id: str, n_envs: int, device: str = "cpu") -> Env:
    env_name = "brax_" + env_id + "v99"
    entry_point = functools.partial(brax_envs.create_gym_env, env_name="cfg.env_name")
    ...
    gym_env = to_torch.JaxToTorchWrapper(gym_env, device=cfg.device)  # type: ignore
